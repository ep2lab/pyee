...
def interpH2W(data, sim_path):
    ...
    # Avoid P=0 (change propagation region method)
    Nwave[PointFlag == False]  = 0.5e14
    normB[PointFlag == False]  = 0
    ...
    # Filter the plasma frequency for a smooth transition
    omega_pe  = scp.gaussian_filter(omega_pe , (2*Nz/100, 2*Nx/100))
